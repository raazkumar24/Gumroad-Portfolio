  ...
  return (
    <div className="pt-32 space-y-24 relative overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <span className="font-black uppercase tracking-[0.4em] text-xs text-black dark:text-white">
            ...
            <h1 className="text-6xl md:text-9xl font-black tracking-tighter uppercase leading-[0.85] text-black dark:text-white">
              Crafting <br />
              <span className="text-black/10 dark:text-white/10 ghost-text">
                Digital
              </span>{" "}
              <br />
            ...
            <p className="text-2xl md:text-3xl font-bold text-gray-700 dark:text-gray-300 max-w-3xl leading-tight">
              Hi, I'm <span className="text-blue-600">Raj Shekhar</span>. A
              Full-stack Engineer bridging the gap between{" "}
              <span className="bg-green-400 text-black px-2">
                complex logic
              </span>{" "}
            ...
            <div className="flex flex-wrap gap-8 pt-6">
              <Link to="/projects">
                <NeoButton
                  variant="primary"
                  className="py-5 px-12 text-xl !bg-black !text-white dark:!bg-white dark:!text-black hover:!bg-blue-600 hover:!text-white transition-all transform hover:-rotate-2"
                >
                  View Projects
                </NeoButton>
              </Link>
              <Link to="/contact">
                <NeoButton
                  variant="accent"
                  className="py-5 px-12 text-xl hover:!bg-black hover:!text-yellow-400 transition-all transform hover:rotate-2"
                >
                  Let's Talk
                </NeoButton>
              </Link>
          ...
          <motion.div
            ...
            className="lg:col-span-4 hidden lg:block relative group"
          >
            <div className="relative max-w-sm mx-auto z-10">
              {/* Layered Decorative Backgrounds */}
              <div
                className="absolute -inset-6 bg-blue-600 -rotate-6 border-8 border-black z-10
      group-hover:rotate-0 group-hover:scale-105
      transition-all duration-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.1)]"
              />
              <div
                className="absolute -inset-6 bg-yellow-400 rotate-6 border-8 border-black z-0
      group-hover:rotate-0 group-hover:scale-105
      transition-all duration-500"
              ...
              {/* Floating Badge */}
              <div
                className="absolute -top-12 -left-12 z-30 w-28 h-28 bg-white border-4 border-black
        ...
        transition-all duration-1000"
                ...
                <div className="p-5 bg-black text-white flex justify-between items-center border-t-8 border-black">
                  <div className="flex flex-col">
                    <span className="font-black uppercase tracking-[0.2em] text-[10px] text-blue-400">
                      Title
                    </span>
                  ...
                  <div
                    className="w-10 h-10 bg-yellow-400 border-2 border-white flex items-center justify-center
          -rotate-12 group-hover:rotate-0 transition-transform"
                  >
                    <Zap
                      size={20}
                      fill="#000"
              ...
              <div
                className="absolute -bottom-6 -right-6 bg-green-400 border-4 border-black px-4 py-2
      rotate-6 group-hover:rotate-0 transition-transform
      ...
      {/* Marquee Section */}
      <section className="bg-black text-white lg:py-12 py-6 border-y-4 border-black overflow-hidden relative">
        <motion.div
          animate={{ x: [0, -1500] }}
        ...
        >
          {Array(10)
            ...
            .map((_, i) => (
              <div
                key={i}
                className="flex items-center gap-12 lg:text-5xl text-3xl font-black uppercase italic"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          >
            <motion.h2
              ...
              className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-none text-black dark:text-white"
            >
              Engineering <br /> with a <br />{" "}
              <span className="text-blue-600 italic">Vision.</span>
            </motion.h2>
              ...
              {[
                {
                  ...
                  desc: "Architecture designed for millions, using industry-standard SOLID principles.",
                },
                {
                  icon: <Globe size={32} className="text-yellow-500" />,
                  title: "High Fidelity",
                  desc: "Pixel-perfect UI across all platforms with 99.9% uptime focus.",
                },
                {
                  icon: <Shield size={32} className="text-green-500" />,
                  title: "Bulletproof Security",
                  desc: "Enterprise encryption and secure data handling as a core requirement.",
                },
              ].map((item, i) => (
                <motion.div
                  variants={itemVariants}
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-3xl font-black uppercase tracking-tighter text-black dark:text-white">
                      {item.title}
                    </h4>
                    <p className="text-xl text-gray-600 dark:text-gray-400 font-bold leading-tight">
                      {item.desc}
                    </p>
                  </div>
                </motion.div>
          ...
          >
            ...
            <div className="relative bg-white dark:bg-neutral-900 border-4 border-black dark:border-white p-12 neo-shadow">
              <div className="flex items-center gap-6 mb-10">
                ...
                <h3 className="text-4xl font-black uppercase italic text-black dark:text-white">
                  The Stack
                </h3>
              </div>
              <p className="text-2xl font-bold text-gray-700 dark:text-gray-300 mb-12 leading-relaxed italic">
                "I don't just build websites; I craft ecosystems. Performance
                and accessibility aren't features; they're foundation."
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="p-8 bg-gray-50 dark:bg-black border-4 border-black flex flex-col items-center group hover:bg-yellow-400 transition-colors">
                  <span className="lg:text-5xl text-3xl font-black text-black dark:text-white group-hover:text-black">
                    99.9%
                  </span>
                  <span className="text-xs font-black uppercase tracking-[0.3em] text-gray-500 group-hover:text-black mt-2">
                    Quality Focus
                  </span>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-32">
        ...
        >
          ...
          <Link to="/contact" className="inline-block relative z-10 pt-10">
            <NeoButton
              variant="primary"
              className="!bg-black !text-white text-3xl py-8 px-20 shadow-[12px_12px_0px_0px_rgba(255,255,255,0.3)] hover:shadow-none transition-all hover:scale-105 active:scale-95"
            >
              Hire Raj Shekhar
            </NeoButton>
          </Link>
